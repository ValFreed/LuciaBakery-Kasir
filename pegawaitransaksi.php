                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="pegawaiview.php?kodef=<?=$kode_faktur;?>" class="btn btn-primary" >Lihat</a> 
...
<div class="modal fade" id="myModal">
  <div class="modal-dialog">
    ...
    <form method="post">
      ...
      <!-- Modal footer -->
      <div class="modal-footer">
        <button type="submit" class="btn btn-success" name="tambahfaktur2">Tambahkan</button> <!-- Masuk Faktur-->
