...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-danger">
            ...
            <!-- Navbar-->
            <a class="navbar-brand"><?php echo $_SESSION['pegawai'];?></a>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="pegawaipelanggan.php">
                                <div class="sb-nav-link-icon"><i class="far fa-handshake"></i></div>
                                Pelanggan
                            </a>
                            
                            <a class="nav-link" href="pegawaitransaksi.php">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        ...
                                        <div class="modal-body">
                                                Nama Jajan
                                                <input type="text" name="nama_jajan" class="form-control mb-2" placeholder="Nama Jajan" value="<?=$nama_jajan;?>" readonly>
                                                Jumlah Jajan
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="editjajanpembeli2">Edit</button>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <!-- Modal footer -->
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-success" name="hapusjajanpembeli2">Ya</button>
  ...
  <div class="modal-dialog">
    ...
    <form method="post">
      ...
      <div class="modal-body">
        ...
        <input type="number" name="kuantitas" class="form-control mt-4" placeholder="Jumlah Jajan" min="1" required>
        <input type="hidden" name="kodef" value="<?=$kodef;?>">
      </div>

      <!-- Modal footer -->
      <div class="modal-footer">
        <button type="submit" class="btn btn-success" name="tambahjajanpembeli2">Tambahkan</button>
        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
      </div>
...
<!---------------------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            ...
            Total Pembelian
            <input type="text" name="total" class="form-control mb-2" placeholder="Total" value="<?=number_format($total);?>" readonly>
            Jumlah Yang Dibayar
            <input type="number" name="jumlah_bayar" class="form-control mb-2" placeholder="Jumlah dibayar">
            <input type="hidden" name="kodef" value="<?=$kodef;?>">
        </div>
        
        <!-- Modal footer -->
        <div class="modal-footer">
            <button type="submit" class="btn btn-success" name="bayar2">Bayar</button>
            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
        </div>
