...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">Lucia Bakery</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Jumlah Jajan: <?php echo $jumlahtransaksi ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                        $get = mysqli_query($conn,"select * from faktur f, pelanggan pl where f.id_pelanggan=pl.id_pelanggan");
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$jumlah;?></td>
                                            <td><button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#edit">Edit</button>
  ...
  <div class="modal-dialog">
    ...
    <form method="post">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-success" name="tambahfaktur">Tambahkan</button>
